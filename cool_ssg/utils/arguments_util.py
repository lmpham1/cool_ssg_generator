...
def parse_arguments():
    ...
    parser.add_argument('-s', '--stylesheets', nargs='+', help='attach stylesheet URLs')
    parser.add_argument('-l', '--lang', help='language of the generated documents, default is en-CA')
    parser.add_argument('-c', '--config', help='path to the config file')
    parser.add_argument('-sb', '--sidebar', nargs='?', help='generate sidebar from a sidebar config file, default sidebar will be used if no config file is specified', const="use_default", default=None)
