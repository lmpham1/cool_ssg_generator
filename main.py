...
def parseArguments():
    ...
    version_group.add_argument('-v', '--version', action='version', version='cool_ssg_generator release 0.1', help='display the current version')
    other_group.add_argument('-i', '--input', nargs='+', help='path to input file or directory', required=True)
    other_group.add_argument('-o', '--output', nargs=1, help='path to output directory')
    other_group.add_argument('-s', '--stylesheet', nargs='+', help='attach stylesheet URL')
